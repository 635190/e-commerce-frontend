                            ...
                            <div className="space-y-4">
                              <FormControl>
                                <RadioGroup
                                  ...
                                  key={section.id} // Add this line
                                >
                                  {section.options.map((option, optionIdx) => (
                                    <FormControlLabel onClick={(e) => handleRadioFilterChange(e, section.id)} key={option.id} value={option.value} control={<Radio />} label={option.label} />
